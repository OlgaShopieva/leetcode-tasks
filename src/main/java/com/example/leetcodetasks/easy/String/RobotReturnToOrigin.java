...
public class RobotReturnToOrigin {
    ...
    public static boolean judgeCircle(String moves) {
        int countUDBalance = 0;
        int countRLBalance = 0;
        for(char ch: moves.toCharArray()) {
            switch (ch) {
                case 'U': countUDBalance++; break;
                case 'D': countUDBalance--; break;
                case 'R': countRLBalance++; break;
                case 'L': countRLBalance--; break;
            }
        }
        return countUDBalance == 0 && countRLBalance == 0;
    }
