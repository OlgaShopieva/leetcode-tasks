 ...
 * does not exceed 100 pixels. Then, from where you stopped in s, continue writing as many letters as you can
...
public class NumberOfLinesToWriteString {
    ...
    public static int[] numberOfLines(int[] widths, String s) {
        ...
        for (char ch: s.toCharArray()) {
            int curPix = widths[ch - 'a'];
            if(lineCount+ curPix > maxPix) {
                lineCount = curPix;
                totalLines++;
            } else {
                lineCount += curPix;
